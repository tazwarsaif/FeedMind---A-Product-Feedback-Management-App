...
const FeedMindLayout = ({ children, user }) => {
    ...
    const sidebarLinks = [
        ...
        },
        {
            name: "Add Product",
            icon: (
                // Box with plus sign icon (represents adding a product)
                <svg
                    className="w-5 h-5"
                    fill="none"
                    stroke="currentColor"
            ...
            href: "/manager/add-product",
        },
        {
            name: "My Products",
            icon: (
                // Box/package icon for product listing
                <svg
                    className="w-5 h-5"
                    fill="none"
                    stroke="currentColor"
                                                                                                ...
                                                                                                .then(
                                                                                                    (
                                                                                                        ...
                                                                                                        if (
                                                                                                            ...
                                                                                                            window.location.href = `/manager/feedgpt/${data.id}`;
                                                                                                        }
                                                                                                    }
                                                                                                )
                                                                                                .catch(
