    ...
    public function getOneProductWithAnalyzedData(Request $request, $id)
    {
        ...
        public function generateAnalyzedReport(Request $request, $id)
        {
            ...
            try {
                ...
                // Create comprehensive AI prompt with minimal essential data
        ...
        \"rating\": {$essentialProductData['average_rating']}
                ...
                if (!$analysisData) {
                    $analysisData = [
                        ...
                        'summary' => 'Comprehensive analysis of customer feedback and product performance metrics.',
                        'full_report' => $analysisText,
                        'rating' => round($averageRating, 2),
                        'overall_score' => round($averageRating * 2, 1) // Convert 5-point to 10-point scale
                    ];
                }
